...
class ParentWin(Frame):
    def __init__(self, master):
        ...
        self.master.title("Generate your Webpage")
        self.labelTxt = Label(
            text="Would you like to create custom text for your webpage?",
            font=("Arial", 12),
        )
        ...
        self.btnSubmit = Button(
            ...
            width=20,
            height=1,
            command=self.defaultEntry,
        )
        self.btnSubmit.grid(row=2, column=1, padx=(0,10), pady=(0, 10))
        self.txtEntry = Entry(self.master, font=("Helvetica", 12))
        self.txtEntry.grid(
            row=1, column=0, padx=(30, 15), pady=(10, 10), columnspan=3, sticky=W + E
        )
        self.btnSubmit = Button(
            self.master,
            text="Submit Custom Text",
            width=20,
            height=1,
            command=self.customEntry,
        )
        self.btnSubmit.grid(row=2, column=2, padx=(0, 10), pady=(0, 10))

    def customEntry(self):
        self.labelTxt = Label(
            text="Customize your webpage by entering text, then click to veiw",
            font=("Arial", 12),
        )
